  ...
  <body id="top">
    <div id="root">
      <header id="header" class="header">
        <div class="head-m-01  main-header-fixed">
          <div class="container">
            <div class="header-nav head01-pd col-gp ali-center col-spac">
              <div class="head-logo-div">
                <a href="<?php echo home_url(); ?>">
                  <div class="h-logo">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/h-logo-header.png" alt="JTC logo" class="" />
                  </div>
                </a>
              </div>
              <div class="nav-div-01 down-arr1">
                <ul class="col-gp nav-list col-end ali-center">
                  <li>
                    <a href="<?php echo home_url() ?>" class="font-co">トップ</a>
                  </li>
                  <li class="navi-arr w-color ">
                    <a href="<?php echo home_url() . '/school/'; ?>" class="font-co">
                      <div class="col-gp ali-center">
                        <span>学校紹介</span>
                        <div class="arr-down pl5">
                          <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/down-arr-b.png" alt="arrow-down" class="">
                        </div>
                      </div>
                    </a>
                    <div class="menu-hovergpall">
                      <div class="submenugp">
                        <ul class="submenuli">
                          ...
                          <li class="sub-li">
                            <a href="<?php echo home_url() . '/school/mawlamyine'; ?>" class="font-co">
                              モーラミャイン校
                            </a>
                          </li>
                          <li class="sub-li">
                            <a href="<?php echo home_url() . '/school/mandalay'; ?>" class="font-co">
                              マンダレー校
                            </a>
                          </li>
                        </ul>
                  ...
                  <li>
                    <a href="<?php echo home_url() . '/news/'; ?>" class="font-co">お知らせ</a>
                  </li>
                  <li>
                    <a href="<?php echo home_url() . '/youtube/'; ?>" class="font-co">Youtube動画一覧</a>
                  </li>
                  <li>
                    <a href="<?php echo home_url() . '/contact' ?>" class="font-co">お問い合わせ</a>
                  </li>
                </ul>
              </div>
              <div class="sns-block">
                <ul class="sns-link">
                  <li>
                    <a href="https://www.facebook.com/JapanTrainingCentre" target="_blank">
                      <div class="">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/facebook-black.png" alt="facebook" class="">
                      </div>
                    </a>
                  </li>
                  <li>
                    <a href="https://twitter.com/JTCMawlamyine" target="_blank">
                      <div class="">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/twitter-black.png" alt="twitter" class="">
                      </div>
                    </a>
                  </li>
                  <li>
                    <a href="https://www.youtube.com/channel/UCfp5EYjnl9fFLaSjaXLnMhQ" target="_blank">
                      <div class="">
                        <img src="<?php bloginfo('template_directory'); ?>/assets/img/common/youtube-black.png" alt="youtube" class="">
                      </div>
                    </a>
                  </li>
                </ul>
