...
function the_breadcrumb()
{
  ...
  if (is_home() || is_front_page()) :
    if ($showOnHome == 1) :
      echo '<div id="breadcrumb"><div class="crumb"><ul class="crumb-in cFix"><li><a href="' . $homeLink . '">JTC　トップ</a></li></ul></div></div>';
    endif;
  else :
    echo '<div id="breadcrumb"><div class="crumb"><ul class="crumb-in cFix"><li><a href="' . $homeLink . '">JTC　トップ</a></li><li>';
    ...
    elseif (is_day()) :
      ...
      echo '<li><a href="' . get_month_link(get_the_time('Y'), get_the_time('m')) . '">' . get_the_time('m') . '</a></li> ';
    ...
    elseif (is_single() && !is_attachment()) :
      if (get_post_type() != 'post') :
        ...
        if ($post_type_name == 'news') :
          ...
          echo '<li><a href="' . $homeLink . '/youtube/">Youtube一覧</a></li>';
          if ($showCurrent == 1) :
            echo $before . get_the_title() . $after;
          endif;
        endif;
